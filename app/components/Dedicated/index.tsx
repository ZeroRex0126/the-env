        ...
        <div className="relative">
            ...
            <div className='mx-auto max-w-7xl px-4 my-40 sm:py-20 lg:px-8'>
                <div className='grid grid-cols-1 md:grid-cols-2 my-16'>
                    ...
                    {/* COLUMN-1 */}
                    <div>
                        <Image src="/images/dedicated/ceo.svg" alt="man-icon" width={416} height={530} className="mx-auto md:mx-0" />
                    </div>
                    ...
                    <div className="relative">
                        ...
                        <p className="text-2xl font-semibold mt-12 lg:ml-32 preline text-center lg:text-start"> Xero, CEO</p>
                    </div>
